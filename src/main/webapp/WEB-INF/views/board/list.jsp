...
<body>
	...
	<div class="container">
		...
		<div style="text-align: right">
			<form id="removeAllForm1" action="${appRoot }/board/removeAll"
				method="post">
				<input id="desub" type="submit" value="삭제">
			</form>
		...
		<table class="table table-striped">
				...
				<c:forEach items="${list }" var="board">
					<tr>
						<td><input type="checkbox" name="removeBnoList"
							value="${board.bno }" class="NON" checked=true id="${board.bno }"
							form="removeAllForm1"> ${board.bno }</input></td>
			...
			<script>
				...
				selectAll.addEventListener('click', function() {
					var objs = document.querySelectorAll(".NON");
