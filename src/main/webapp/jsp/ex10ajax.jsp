		...
		$("#submit1").click(function(e) {
			...
			$.post({
				...
				success : function(data) {
					...
					$("#submit1").removeAttr("disabled").html("전송");
...
<body>
	<div class="container">
		...
		<button id="like-button1" data-operation="like">
			<i id="like-icon1" class="far fa-thumbs-up"></i> <span id="like-cnt1">10</span>
		</button>


		<hr>
		<input id="input1" name="id" placeholder="id"> <input
			id="input2" name="age" type="number" placeholder="age">
